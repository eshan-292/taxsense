...
const tools = [
  ...
  {
    title: "Life Events",
    desc: "Buy house, NPS, salary hike",
    href: "/life-events",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: "Freelance Tax",
    desc: "44ADA side income calculator",
    href: "/freelance",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    desc: "Paste Form 16, auto-fill calc",
    href: "/form16",
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-1.5">
                  ...
                  {"badge" in tool && tool.badge && (
                    <span className="rounded-full bg-accent-indigo/15 px-1.5 py-px text-[9px] font-semibold text-accent-indigo leading-none">NEW</span>
                  )}
                </div>
